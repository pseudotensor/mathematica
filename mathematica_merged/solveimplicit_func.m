...
(*filenamebase="failshigherror.txt_outbad.txt";numfails=2;filetype=1;*)
(*filenamebase="listbad181.txt";numfails=303;filetype=1;*)
(*filenamebase="sofarfailshigherror.txt_outbad.txt";numfails=487;filetype=1;*)
...
docontinue=dosolveimplicitone[j,mylist];
If[docontinue==0,Break[];];
Print["Done=",j];
];
Close[str];
...
If[failtype==EndOfFile,Return[0];];
...
For[jj=1,jj<=181,jj++,
WriteString[soutbad,CForm[result181[[jj]]]];
WriteString[soutbad,space];
];
WriteString[soutbad,"\n"];
];
If[justout181==0,
...
varlist={rho,u,uu1,uu2,uu3,Er,uru1,uru2,uru3};
...
varlist={rho,u,uut1,uut2,uut3,Er,urut1,urut2,urut3};
...
(* test *)
testuu=FullSimplify[(ucon.ucov)//.constspin];
...
uradcov=urcov;
(* test *)
testuu=FullSimplify[(urcon.urcov)//.constspin];
...
(* modify u_g guess since solution is sensitive to it *)
(*
sols=FindRoot[{Sc0==S*uu0ii,rho*uu0ii==rho0},{{rho,rhoii},{u,uii}}];
Print["pre-solution: ",sols];
uii=Max[uii,Re[u//.sols]];
rhoii=Min[rhoii,Re[rho//.sols]];
*)
entropy0=S//.constspin;
specificentropy0=entropy0/(rho//.constspin);
rhoE=Abs[rho0/uu0ii];
rhoii=Max[10^(-30),Min[Abs[rhoii],Abs[rhoE]]];
specificentropyE=Sc0/rho0;
entropyE=specificentropyE*rhoii;
myS=S//.{rho->rhoii};
myu=Solve[myS==entropyE,u];
uiinew=u//.myu;
uii=Max[uii,uiinew];
(*uii=10*uii;*)
Print["pre-solution2: ",rhoii," ",uii];

(* can put Ramesh solution here *)
rhoii=1.3117730752268257*10^(-10);
uii=7.7217774925670164*10^(-13);
(*2.0648663207194398*)
rucon1=1.4063575483103284*10^(-3);
rucon2=2.1940137792995012*10^(-4);
rucon3=5.0433764206278445*10^(-2);
(*2.0146470192031192*)
ruradcon1=4.5603396169445086*10^(-3);
ruradcon2=-2.2632140382290548*10^(-4);
ruradcon3=1.7795064451790129*10^(-2);
rErf=1.1834834940935724*10^(-14);

rhoii=SetPrecision[rhoii,30];
uii=SetPrecision[uii,30];
rucon1=SetPrecision[rucon1,30];
rucon2=SetPrecision[rucon2,30];
rucon3=SetPrecision[rucon3,30];
ruradcon1=SetPrecision[ruradcon1,30];
ruradcon2=SetPrecision[ruradcon2,30];
ruradcon3=SetPrecision[ruradcon3,30];
rErf=SetPrecision[rErf,30];

solsurut=FindRoot[{uradcon[[2]]==ruradcon1,uradcon[[3]]==ruradcon2,uradcon[[4]]==ruradcon3},{{urut1,ruradcon1},{urut2,ruradcon2},{urut3,ruradcon3}},WorkingPrecision->30];
Print["solsurut=",solsurut];
solsuut=FindRoot[{ucon[[2]]==rucon1,ucon[[3]]==rucon2,ucon[[4]]==rucon3},{{uut1,rucon1},{uut2,rucon2},{uut3,rucon3}},WorkingPrecision->30];
Print["solsuut=",solsuut];
...
pin8=rErf;
pin9=urut1//.solsurut;
pin10=urut2//.solsurut;
pin11=urut3//.solsurut;
...
If[complexprims==True,MyPrint["Acomplexprims"];];
...
complexprims=myRe[(u//.chooseresult)]<myIm[(u//.chooseresult)]/badtol||myRe[(rho//.chooseresult)]<myIm[(rho//.chooseresult)]/badtol||myRe[(Er//.chooseresult)]<myIm[(Er//.chooseresult)]/badtol;
If[complexprims==True,MyPrint["AScomplexprims"];];
...
complexprims=myRe[((u//.chooseresult))]<myIm[((u//.chooseresult))]/badtol||myRe[(rho//.chooseresult)]<myIm[(rho//.chooseresult)]/badtol||myRe[(Er//.chooseresult)]<myIm[(Er//.chooseresult)]/badtol;
If[complexprims==True,MyPrint["ARADcomplexprims"];];
...
complexprims=myRe[(u//.chooseresult)]<myIm[(u//.chooseresult)]/badtol||myRe[(rho//.chooseresult)]<myIm[(rho//.chooseresult)]/badtol||myRe[(Er//.chooseresult)]<myIm[(Er//.chooseresult)]/badtol;
If[complexprims==True,MyPrint["1complexprims"];];
...
complexprims=myRe[(u//.chooseresult)]<myIm[(u//.chooseresult)]/badtol||myRe[(rho//.chooseresult)]<myIm[(rho//.chooseresult)]/badtol||myRe[(Er//.chooseresult)]<myIm[(Er//.chooseresult)]/badtol;
If[complexprims==True,MyPrint["2complexprims"];];
...
ferrnorm2={ferrnorm2t[[1]]/Sqrt[Abs[gcon[[1,1]]]],ferrnorm2s/Sqrt[Abs[gcon[[2,2]]]],ferrnorm2s/Sqrt[Abs[gcon[[3,3]]]],ferrnorm2s/Sqrt[Abs[gcon[[4,4]]]]};
ferr0n=(ferr0/ferrnorm0)//.chooseresult;
ferr1n=(ferr1/ferrnorm1)//.chooseresult;
ferr2n=(ferr2/ferrnorm2)//.chooseresult;

ferrtotal=Join[{ferr0n},ferr1n,ferr2n];
ferrabs=Sqrt[myRe[ferrtotal].myRe[ferrtotal]];
ferrabsim=Sqrt[myIm[ferrtotal].myIm[ferrtotal]];
...
complexprims=myRe[(u//.chooseresult)]<myIm[(u//.chooseresult)]/badtol||myRe[(rho//.chooseresult)]<myIm[(rho//.chooseresult)]/badtol||myRe[(Er//.chooseresult)]<myIm[(Er//.chooseresult)]/badtol;
If[complexprims==True,MyPrint["0Scomplexprims"];];
If[ferrabs==0 && ferrabsim==0 || ferrabs<badtol && ferrabsim<badtol&&complexprims==False,resulttype4SnoG="Good",resulttype4SnoG="Bad"];
...
ferrtotalA=Join[{ferr0A},ferr1A,ferr2A];
ferrabsA=SetPrecision[Sum[Abs[ferrtotalA[[ii]]]^2,{ii,1,9}],nminworkprec];
minsol=NMinimize[{ferrabsA},{rho,u,uut1,uut2,uut3,Er,urut1,urut2,urut3},WorkingPrecision->nminworkprec,MaxIterations->nminmaxiter,AccuracyGoal->nminprec,PrecisionGoal->nminprec];
ferrabs=minsol[[1]];
ferrabsim=0.0;
ferrabstotal=ferrabs+ferrabsim;
chooseresultglobal=minsol[[2]];
...
complexprims=myRe[(u//.chooseresult)]<myIm[(u//.chooseresult)]/badtol||myRe[(rho//.chooseresult)]<myIm[(rho//.chooseresult)]/badtol||myRe[(Er//.chooseresult)]<myIm[(Er//.chooseresult)]/badtol;
If[complexprims==True,MyPrint["0Scomplexprims"];];
If[ferrabs==0 && ferrabsim==0 || ferrabs<badtol && ferrabsim<badtol&&complexprims==False,resulttype4S="Good"<>global,resulttype4S="Bad"];
Print["0S",resulttype4S,global," ",global," ",CForm[ferrabs+ferrabsim]," ",myj," ",failtype," ",myid," ",failnum, " cc=",cc];
If[resulttype4S=="Good"<>global,
cc0S=cc0S+cc;
...
complexprims=myRe[(u//.chooseresult)]<myIm[(u//.chooseresult)]/badtol||myRe[(rho//.chooseresult)]<myIm[(rho//.chooseresult)]/badtol||myRe[(Er//.chooseresult)]<myIm[(Er//.chooseresult)]/badtol;
If[complexprims==True,MyPrint["0RADcomplexprims"];];
...
complexprims=myRe[(u//.chooseresult)]<myIm[(u//.chooseresult)]/badtol||myRe[(rho//.chooseresult)]<myIm[(rho//.chooseresult)]/badtol||myRe[(Er//.chooseresult)]<myIm[(Er//.chooseresult)]/badtol;
If[complexprims==True,MyPrint["0Wcomplexprims"];];
...
complexprims=myRe[(u//.chooseresult)]<myIm[(u//.chooseresult)]/badtol||myRe[(rho//.chooseresult)]<myIm[(rho//.chooseresult)]/badtol||myRe[(Er//.chooseresult)]<myIm[(Er//.chooseresult)]/badtol;
If[complexprims==True,MyPrint["0WScomplexprims"];];
...
ferr0n=ferr0/Abs[rho]//.chooseresult;
ferr1n=(ferr1/Max[Abs[(u//.chooseresult)],Abs[(Er//.chooseresult)]])//.chooseresult;
ferr2n=(ferr2/Max[Abs[(u//.chooseresult)],Abs[(Er//.chooseresult)]])//.chooseresult;
ferrtotal=Join[{ferr0n},ferr1n,ferr2n];
ferrabs=Sqrt[myRe[ferrtotal].myRe[ferrtotal]];
ferrabsim=Sqrt[myIm[ferrtotal].myIm[ferrtotal]];
ferrabstotal=ferrabs+ferrabsim;
...
complexprims=myRe[(u//.chooseresult)]<myIm[(u//.chooseresult)]/badtol||myRe[(rho//.chooseresult)]<myIm[(rho//.chooseresult)]/badtol||myRe[(Er//.chooseresult)]<myIm[(Er//.chooseresult)]/badtol;
If[complexprims==True,Print["0Mcomplexprims"];];
If[ferrabs==0 && ferrabsim==0 || ferrabs<badtol && ferrabsim<badtol&&complexprims==False,resulttype8="Good"<>global,resulttype8="Bad"];
Print["0M",resulttype8,global," ",global," ",CForm[ferrabs+ferrabsim]," ",myj," ",failtype," ",myid," ",failnum, " cc=",cc];
...
complexprims=myRe[(u//.chooseresult)]<myIm[(u//.chooseresult)]/badtol||myRe[(rho//.chooseresult)]<myIm[(rho//.chooseresult)]/badtol||myRe[(Er//.chooseresult)]<myIm[(Er//.chooseresult)]/badtol;
If[complexprims==True,Print["0Qcomplexprims"];];
If[ferrabs==0 && ferrabsim==0 || ferrabs<badtol && ferrabsim<badtol&&complexprims==False,resulttype8Q="Good"<>global,resulttype8Q="Bad"];
Print["0Q",resulttype8Q,global," ",global," ",CForm[ferrabs+ferrabsim]," ",myj," ",failtype," ",myid," ",failnum, " cc=",cc];
...
complexprims=myRe[(u//.chooseresult)]<myIm[(u//.chooseresult)]/badtol||myRe[(rho//.chooseresult)]<myIm[(rho//.chooseresult)]/badtol||myRe[(Er//.chooseresult)]<myIm[(Er//.chooseresult)]/badtol;
If[complexprims==True,Print["0MRADcomplexprims"];];
...
complexprims=myRe[(u//.chooseresult)]<myIm[(u//.chooseresult)]/badtol||myRe[(rho//.chooseresult)]<myIm[(rho//.chooseresult)]/badtol||myRe[(Er//.chooseresult)]<myIm[(Er//.chooseresult)]/badtol;
If[complexprims==True,MyPrint["0MScomplexprims"];];
If[ferrabs==0 && ferrabsim==0 || ferrabs<badtol && ferrabsim<badtol&&complexprims==False,resulttype4MS="Good"<>global,resulttype4MS="Bad"];
Print["0MS",resulttype4MS,global," ",global," ",CForm[ferrabs+ferrabsim]," ",myj," ",failtype," ",myid," ",failnum, " cc=",cc];
If[resulttype4MS=="Good"<>global,
(*
cc0MS=cc0MS+cc;
...
complexprims=myRe[(u//.chooseresult)]<myIm[(u//.chooseresult)]/badtol||myRe[(rho//.chooseresult)]<myIm[(rho//.chooseresult)]/badtol||myRe[(Er//.chooseresult)]<myIm[(Er//.chooseresult)]/badtol;
If[complexprims==True,MyPrint["0QScomplexprims"];];
If[ferrabs==0 && ferrabsim==0 || ferrabs<badtol && ferrabsim<badtol&&complexprims==False,resulttype4QS="Good"<>global,resulttype4QS="Bad"];
Print["0QS",resulttype4QS,global," ",global," ",CForm[ferrabs+ferrabsim]," ",myj," ",failtype," ",myid," ",failnum, " cc=",cc];
If[resulttype4QS=="Good"<>global,
(*
cc0QS=cc0QS+cc;
...
resultB=If[resulttype4MS=="GoodL" || resulttype4QS=="GoodL" || resulttype3=="GoodL" || resulttype4S=="GoodL"  || resulttype8=="GoodL" || resulttype8Q=="GoodL"resulttype4MS=="GoodG" || resulttype4QS=="GoodG" || resulttype3=="GoodG" || resulttype4S=="GoodG"  || resulttype8=="GoodG" || resulttype8Q=="GoodG",1,0];
resultC=If[resulttype4MS=="GoodL"&&uentropyms>0&&complexentropyms==False||resulttype4QS=="GoodL"&&uentropyqs>0&&complexentropyqs==False||resulttype3=="GoodL"&&uenergy>0&&complexenergy==False||resulttype4S=="GoodL"&&uentropy>0&&complexentropy==False||resulttype8=="GoodL"&&uenergym>0&&complexenergym==False||resulttype8Q=="GoodL"&&uenergyq>0&&complexenergyq==False||resulttype4MS=="GoodG"&&uentropyms>0&&complexentropyms==False||resulttype4QS=="GoodG"&&uentropyqs>0&&complexentropyqs==False||resulttype3=="GoodG"&&uenergy>0&&complexenergy==False||resulttype4S=="GoodG"&&uentropy>0&&complexentropy==False||resulttype8=="GoodG"&&uenergym>0&&complexenergym==False||resulttype8Q=="GoodG"&&uenergyq>0&&complexenergyq==False,1,0];
...
Print["SolutionType: ",myj," ",resulttype3," ",resulttype4S," ",resulttype8," ",resulttype4MS," ",resulttype8Q," ",resulttype4QS,"   ",resultA," ",resultB," ",resultC];
