...
If[uenergy<=0 && uentropy>0&&complexentropy==False,Print["SHOULDUSEENTROPYNEGU"];];
If[rhoenergy<=0 && rhoentropy>0&&complexentropy==False,Print["SHOULDUSEENTROPYNEGU"];];
If[Erenergy<=0 && Erentropy>0&&complexentropy==False,Print["SHOULDUSEENTROPYNEGU"];];
